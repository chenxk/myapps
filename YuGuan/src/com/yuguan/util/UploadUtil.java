...
public class UploadUtil {
	...
	private void toUploadFile(File file, String fileKey, String RequestURL,
		...
		try {
			...
			if (res == 200) {
				...
				sendMessageByHandler(UPLOAD_SUCCESS_CODE, "上传结果：" + result);
				
				return;
			} else {
				Log.e(TAG, "request error");
				sendMessageByHandler(UPLOAD_SERVER_ERROR_CODE, "上传失败：code=" + res);
				judgeSeccuss = false;
				return;
			}
		} catch (MalformedURLException e) {
			sendMessageByHandler(UPLOAD_SERVER_ERROR_CODE,
	...
	public void sendMessageByHandler(int responseCode, String responseMessage){
