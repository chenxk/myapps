...
//		AlphaAnimation myalphaanim1 = new AlphaAnimation(1,0);
//		myalphaanim1.setDuration(2000);
//		anim.addAnimation(myalphaanim1);
...
//		AlphaAnimation myalphaanim2 = new AlphaAnimation(1,0);
//		myalphaanim2.setDuration(2000);
//		anim1.addAnimation(myalphaanim2);
		...
		new Handler().postDelayed(new Runnable(){
			@Override
			public void run(){
				WhatsnewDoor.this.setVisible(false);
